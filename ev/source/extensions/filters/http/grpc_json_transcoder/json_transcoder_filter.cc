...
JsonTranscoderConfig::JsonTranscoderConfig(
  ...
  std::cout << "JsonTranscoderConfig::JsonTranscoderConfig ";
  std::cout << proto_config.descriptor_set_case() << std::endl;
  ...
  default:
    break;
    // TODO: Tests cause control to go here which SIGABORTs the test. However in non-test scenarios, this should assert 
