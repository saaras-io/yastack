...
public:
  ...
  Network::SocketSharedPtr createListenSocket(Network::Address::InstanceConstSharedPtr address,
                                              ...
                                              bool bind_to_port, uint8_t provider) override;
...
public:
  ...
  ListenerManagerImpl(Instance& server, ListenerComponentFactory& listener_factory,
                      WorkerFactory& worker_factory, TimeSource& time_source, Event::Dispatcher& main_thread_dispatcher);
#endif
...
public:
  ...
  uint8_t provider() { return provider_; }
