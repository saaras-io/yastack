...
SysCallSizeResult MockOsSysCalls::write(int64_t fd, const void* buffer, size_t num_bytes) {
...
SysCallIntResult MockOsSysCalls::setsockopt(int64_t sockfd, int level, int optname, const void* optval,
                               socklen_t optlen) {
