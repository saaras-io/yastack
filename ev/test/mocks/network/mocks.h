...
public:
  ...
  MOCK_CONST_METHOD1(socket, int64_t(Address::SocketType));
  MOCK_CONST_METHOD2(socket, int64_t(uint8_t, Address::SocketType));
  MOCK_CONST_METHOD0(provider, Envoy::Network::Address::SocketProvider());
  MOCK_METHOD1(provider, void(const Envoy::Network::Address::SocketProvider));
