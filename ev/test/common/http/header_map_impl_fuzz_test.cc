...
DEFINE_PROTO_FUZZER(const test::common::http::HeaderMapImplFuzzTestCase& input) {
  ...
  for (int i = 0; i < input.actions().size(); ++i) {
    ...
    case test::common::http::Action2::kAddReference: {
    ...
    case test::common::http::Action2::kAddReferenceKey: {
    ...
    case test::common::http::Action2::kAddCopy: {
    ...
    case test::common::http::Action2::kSetReference: {
    ...
    case test::common::http::Action2::kSetReferenceKey: {
    ...
    case test::common::http::Action2::kGetAndMutate: {
