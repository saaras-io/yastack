...
// Everything moved to http_integration.cc to get around this problem below
///home/ubuntu/falcon4/falcon/build/ev_lib/libev-test-integration.a(utility.cc.o): In function `fmt::fprintf(_IO_FILE*, fmt::BasicCStringRef<char>, fmt::ArgList)':
///usr/include/c++/5/bits/stl_algobase.h:723: multiple definition of `fmt::fprintf(_IO_FILE*, fmt::BasicCStringRef<char>, fmt::ArgList)'
///home/ubuntu/falcon4/falcon/build/ev_lib/libev-test-integration.a(http_integration.cc.o):/home/ubuntu/falcon4/falcon/ev/external/fmt-4.0.0/fmt/printf.cc:22: first defined here
...
//   "tid [{}] IntegrationCodecClient::IntegrationCodecClient() register IntegrationCodecClient() for connection events, run blocking dispatcher ",std::this_thread::get_id());
...
//  ENVOY_LOG_MISC(critical,
//   "tid [{}] IntegrationCodecClient::flushWrite() running dispatcher_ in nonblock ",std::this_thread::get_id());
...
//
//  ENVOY_LOG_MISC(critical, "tid[{}] IntegrationCodecClient::makeHeaderOnlyRequest() ",std::this_thread::get_id());
...
//  ENVOY_LOG_MISC(critical,
//   "tid [{}] Connection event IntegrationCodecClient::onEvent() ",std::this_thread::get_id());
...
//  ENVOY_LOG_MISC(critical,
//   "tid [{}] HttpIntegrationTest::makeHttpConnection() ",std::this_thread::get_id());
...
//
//  ENVOY_LOG_MISC(critical,
//   "tid [{}] HttpIntegrationTest::sendRequestAndWaitForResponse() ",std::this_thread::get_id());
