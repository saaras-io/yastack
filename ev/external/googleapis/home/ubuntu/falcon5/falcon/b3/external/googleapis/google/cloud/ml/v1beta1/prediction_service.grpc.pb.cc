...
::grpc::ClientAsyncResponseReader< ::google::api::HttpBody>* OnlinePredictionService::Stub::PrepareAsyncPredictRaw(::grpc::ClientContext* context, const ::google::cloud::ml::v1beta1::PredictRequest& request, ::grpc::CompletionQueue* cq) {
...
OnlinePredictionService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< OnlinePredictionService::Service, ::google::cloud::ml::v1beta1::PredictRequest, ::google::api::HttpBody>(
