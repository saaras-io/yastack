...
#include "google/cloud/videointelligence/v1beta1/video_intelligence.grpc.pb.h"
...
::grpc::Status VideoIntelligenceService::Stub::AnnotateVideo(::grpc::ClientContext* context, const ::google::cloud::videointelligence::v1beta1::AnnotateVideoRequest& request, ::google::longrunning::Operation* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_AnnotateVideo_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>* VideoIntelligenceService::Stub::AsyncAnnotateVideoRaw(::grpc::ClientContext* context, const ::google::cloud::videointelligence::v1beta1::AnnotateVideoRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>* VideoIntelligenceService::Stub::PrepareAsyncAnnotateVideoRaw(::grpc::ClientContext* context, const ::google::cloud::videointelligence::v1beta1::AnnotateVideoRequest& request, ::grpc::CompletionQueue* cq) {
...
VideoIntelligenceService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< VideoIntelligenceService::Service, ::google::cloud::videointelligence::v1beta1::AnnotateVideoRequest, ::google::longrunning::Operation>(
...
::grpc::Status VideoIntelligenceService::Service::AnnotateVideo(::grpc::ServerContext* context, const ::google::cloud::videointelligence::v1beta1::AnnotateVideoRequest* request, ::google::longrunning::Operation* response) {
  (void) context;
  (void) request;
  (void) response;
