...
inline void InitDefaults() {
  InitDefaultsPolicy();
  InitDefaultsBinding();
  InitDefaultsPolicyDelta();
  InitDefaultsBindingDelta();
}
}  // namespace protobuf_google_2fiam_2fv1_2fpolicy_2eproto
namespace google {
namespace iam {
...
class Policy : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.iam.v1.Policy) */ {
 ...
 private:
  ...
  friend void ::protobuf_google_2fiam_2fv1_2fpolicy_2eproto::InitDefaultsPolicyImpl();
};
// -------------------------------------------------------------------
...
class Binding : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.iam.v1.Binding) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_google_2fiam_2fv1_2fpolicy_2eproto::TableStruct;
  friend void ::protobuf_google_2fiam_2fv1_2fpolicy_2eproto::InitDefaultsBindingImpl();
};
// -------------------------------------------------------------------
...
class PolicyDelta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.iam.v1.PolicyDelta) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_google_2fiam_2fv1_2fpolicy_2eproto::TableStruct;
  friend void ::protobuf_google_2fiam_2fv1_2fpolicy_2eproto::InitDefaultsPolicyDeltaImpl();
};
// -------------------------------------------------------------------
...
class BindingDelta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.iam.v1.BindingDelta) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_google_2fiam_2fv1_2fpolicy_2eproto::TableStruct;
  friend void ::protobuf_google_2fiam_2fv1_2fpolicy_2eproto::InitDefaultsBindingDeltaImpl();
};
// ===================================================================
