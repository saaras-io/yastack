 ...
 public:
  ...
  class WithAsyncMethod_AnnotateVideo : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status AnnotateVideo(::grpc::ServerContext* context, const ::google::cloud::videointelligence::v1beta2::AnnotateVideoRequest* request, ::google::longrunning::Operation* response) final override {
      abort();
