 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::cloud::speech::v1beta1::SyncRecognizeResponse>> PrepareAsyncSyncRecognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1beta1::SyncRecognizeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::cloud::speech::v1beta1::SyncRecognizeResponse>>(PrepareAsyncSyncRecognizeRaw(context, request, cq));
    }
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::longrunning::Operation>> PrepareAsyncAsyncRecognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1beta1::AsyncRecognizeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::longrunning::Operation>>(PrepareAsyncAsyncRecognizeRaw(context, request, cq));
    }
    ...
    std::unique_ptr< ::grpc::ClientAsyncReaderWriterInterface< ::google::cloud::speech::v1beta1::StreamingRecognizeRequest, ::google::cloud::speech::v1beta1::StreamingRecognizeResponse>> PrepareAsyncStreamingRecognize(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderWriterInterface< ::google::cloud::speech::v1beta1::StreamingRecognizeRequest, ::google::cloud::speech::v1beta1::StreamingRecognizeResponse>>(PrepareAsyncStreamingRecognizeRaw(context, cq));
    }
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::google::cloud::speech::v1beta1::SyncRecognizeResponse>* PrepareAsyncSyncRecognizeRaw(::grpc::ClientContext* context, const ::google::cloud::speech::v1beta1::SyncRecognizeRequest& request, ::grpc::CompletionQueue* cq) = 0;
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::google::longrunning::Operation>* PrepareAsyncAsyncRecognizeRaw(::grpc::ClientContext* context, const ::google::cloud::speech::v1beta1::AsyncRecognizeRequest& request, ::grpc::CompletionQueue* cq) = 0;
    ...
    virtual ::grpc::ClientAsyncReaderWriterInterface< ::google::cloud::speech::v1beta1::StreamingRecognizeRequest, ::google::cloud::speech::v1beta1::StreamingRecognizeResponse>* PrepareAsyncStreamingRecognizeRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::google::cloud::speech::v1beta1::SyncRecognizeResponse>> PrepareAsyncSyncRecognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1beta1::SyncRecognizeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::google::cloud::speech::v1beta1::SyncRecognizeResponse>>(PrepareAsyncSyncRecognizeRaw(context, request, cq));
    }
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>> PrepareAsyncAsyncRecognize(::grpc::ClientContext* context, const ::google::cloud::speech::v1beta1::AsyncRecognizeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>>(PrepareAsyncAsyncRecognizeRaw(context, request, cq));
    }
    ...
    std::unique_ptr<  ::grpc::ClientAsyncReaderWriter< ::google::cloud::speech::v1beta1::StreamingRecognizeRequest, ::google::cloud::speech::v1beta1::StreamingRecognizeResponse>> PrepareAsyncStreamingRecognize(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderWriter< ::google::cloud::speech::v1beta1::StreamingRecognizeRequest, ::google::cloud::speech::v1beta1::StreamingRecognizeResponse>>(PrepareAsyncStreamingRecognizeRaw(context, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::google::cloud::speech::v1beta1::SyncRecognizeResponse>* PrepareAsyncSyncRecognizeRaw(::grpc::ClientContext* context, const ::google::cloud::speech::v1beta1::SyncRecognizeRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    ::grpc::ClientAsyncResponseReader< ::google::longrunning::Operation>* PrepareAsyncAsyncRecognizeRaw(::grpc::ClientContext* context, const ::google::cloud::speech::v1beta1::AsyncRecognizeRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    ::grpc::ClientAsyncReaderWriter< ::google::cloud::speech::v1beta1::StreamingRecognizeRequest, ::google::cloud::speech::v1beta1::StreamingRecognizeResponse>* PrepareAsyncStreamingRecognizeRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) override;
    const ::grpc::internal::RpcMethod rpcmethod_SyncRecognize_;
    const ::grpc::internal::RpcMethod rpcmethod_AsyncRecognize_;
   ...
   public:
    WithStreamedUnaryMethod_SyncRecognize() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::speech::v1beta1::SyncRecognizeRequest, ::google::cloud::speech::v1beta1::SyncRecognizeResponse>(std::bind(&WithStreamedUnaryMethod_SyncRecognize<BaseClass>::StreamedSyncRecognize, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_AsyncRecognize() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::speech::v1beta1::AsyncRecognizeRequest, ::google::longrunning::Operation>(std::bind(&WithStreamedUnaryMethod_AsyncRecognize<BaseClass>::StreamedAsyncRecognize, this, std::placeholders::_1, std::placeholders::_2)));
    }
