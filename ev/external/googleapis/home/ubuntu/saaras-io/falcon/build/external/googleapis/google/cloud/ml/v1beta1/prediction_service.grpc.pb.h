...
class OnlinePredictionService final {
 public:
  static constexpr char const* service_full_name() {
    return "google.cloud.ml.v1beta1.OnlinePredictionService";
  }
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::google::api::HttpBody>> PrepareAsyncPredict(::grpc::ClientContext* context, const ::google::cloud::ml::v1beta1::PredictRequest& request, ::grpc::CompletionQueue* cq) {
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::google::api::HttpBody>* PrepareAsyncPredictRaw(::grpc::ClientContext* context, const ::google::cloud::ml::v1beta1::PredictRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::google::api::HttpBody>> PrepareAsyncPredict(::grpc::ClientContext* context, const ::google::cloud::ml::v1beta1::PredictRequest& request, ::grpc::CompletionQueue* cq) {
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::google::api::HttpBody>* PrepareAsyncPredictRaw(::grpc::ClientContext* context, const ::google::cloud::ml::v1beta1::PredictRequest& request, ::grpc::CompletionQueue* cq) override;
   ...
   public:
    WithStreamedUnaryMethod_Predict() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::google::cloud::ml::v1beta1::PredictRequest, ::google::api::HttpBody>(std::bind(&WithStreamedUnaryMethod_Predict<BaseClass>::StreamedPredict, this, std::placeholders::_1, std::placeholders::_2)));
    }
